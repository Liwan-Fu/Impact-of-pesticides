...
combined[,'Old-new-pesticide']=sOld_new_pesticide[index,'Old.or.new.pesticides']
...
write.xlsx(S3,'Supplementary table 2(3).xls',row.names = F)
save.image(file = 'Supplementary Table 2(3).Rdata')
