...
colnames(res) <- c("Predictor variables",
                   ...
                   "test-value",
                   "P-value")
write.csv(res, "SuppTab2-1_1104.csv", row.names = F)
...
colnames(res) <- c("Predictor variables",
                   ...
                   "test-value",
                   "P-value")
write.csv(res, "SuppTab2-2_1104.csv", row.names = F)
...
colnames(res) <- c("Predictor variables",
                   ...
                   "test-value",
                   "P-value")
write.csv(res, "SuppTab2-3_1104.csv", row.names = F)
...
colnames(res) <- c("Predictor variables",
                   ...
                   "test-value",
                   "P-value")
write.csv(res, "SuppTab2-4_1104.csv", row.names = F)
...
colnames(res) <- c("Predictor variables",
                   ...
                   "test-value",
                   "P-value")
write.csv(res, "SuppTab2-5_1104.csv", row.names = F)
